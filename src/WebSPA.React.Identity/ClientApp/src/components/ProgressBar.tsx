 ...
 *
 * @export
 * @param {RequestInfo} input The url you want to send a request to.
 ...
 */
export async function progressBarFetch(input: RequestInfo, options?: RequestInit): Promise<Response> {
