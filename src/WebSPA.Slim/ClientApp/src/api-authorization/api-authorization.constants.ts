export const ApplicationName = 'MyAlbum';
...
let applicationPaths: ApplicationPathsType = {
  ...
  ApiAuthorizationClientConfigurationUrl: `https://localhost:5009/_configuration/${ApplicationName}`,
  ...
  IdentityRegisterPath: 'https://localhost:5009/Identity/Account/Register',
  IdentityManagePath: 'https://localhost:5009/Identity/Account/Manage'
};
